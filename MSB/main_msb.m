...
MSG = 'LOREM IPSUM DOLOR SIT AMET, CONSECTETUR ADIPISCING ELIT, SED DO EIUSMOD TEMPOR INCIDIDUNT UT LABORE ... (TEXTO COMPLETO)';
...
%% Caso F: MSB + RSA  (ya estaba en MSB)
e = 17;
d = 2753;
n = 3233;
